...
│  - Wind speed (ADC) │                      │  - Physical buttons  │                  │                  │
│  - ADS1115 @ 0x49   │                      │  - WiFi → RainMaker │                  │  - Dashboard     │
└─────────────────────┘                      └─────────────────────┘                  │  - Relay Control │
                                                                                      │  - Schedules     │
                                                                                      │  - Actions/Alarms│
                                                                                      │  - Settings      │
...
- Sends `CMD_SENSOR_DATA` (0x09) every 2 seconds: flow rate, total liters, water temp, rain status, wind speed
...
- 16 relay switches, room temp/humidity, water flow/temp/rain/wind sensors, alarm devices (5 types)
